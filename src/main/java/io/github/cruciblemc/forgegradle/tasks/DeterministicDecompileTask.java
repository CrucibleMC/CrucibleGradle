...
//import io.github.cruciblemc.forgegradle.extrastuff.FFPatcher;
//import io.github.cruciblemc.forgegradle.extrastuff.FmlCleanup;
//import io.github.cruciblemc.forgegradle.extrastuff.GLConstantFixer;
//import io.github.cruciblemc.forgegradle.extrastuff.McpCleanup;
//import io.github.cruciblemc.forgegradle.patching.ContextualPatch;
//import io.github.cruciblemc.forgegradle.patching.ContextualPatch.HunkReport;
//import io.github.cruciblemc.forgegradle.patching.ContextualPatch.PatchReport;
//import io.github.cruciblemc.forgegradle.patching.ContextualPatch.PatchStatus;
    ...
    private void decompile(final File inJar, final File outJar, final File fernFlower) {
        this.getProject().javaexec(new Closure<JavaExecSpec>(this) {
            ...
            public JavaExecSpec call() {
                ...
                exec.setStandardOutput(Constants.getTaskLogStream(DeterministicDecompileTask.this.getProject(), DeterministicDecompileTask.this.getName() + ".log"));
